...
const SeriesOffering = () => {
  ...
  // Filter hanya series dari db.json
  const series = melanjutkanData.movies.filter((movie) => movie.type === "Serial TV");
  ...
  if (!series || series.length === 0) return <div className="h-[200px] flex justify-center items-center"><p>No Series Available.</p></div>;
