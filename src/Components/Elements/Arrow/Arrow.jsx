...
const Arrow = ({ onScrollLeft, onScrollRight }) => {
  return (
    <div className="absolute top-1/2 -left-4 -right-4 sm:-left-6 sm:-right-6 -translate-y-1/2 lg:left-2 lg:right-2 hidden sm:flex justify-between items-center z-20"> {/* Sedikit penyesuaian posisi & z-index lebih tinggi */}
      <button
